...
def main():
    ...
    try:
        ...
        print(f"Detailed error during dataloader creation: {str(e)}")
        import traceback
        traceback.print_exc()
        train_dl = None
    ...
    if args.val_dataset_config:
        # print("Debug: Verifying validation dataset configuration...")
        # print(args.val_dataset_config)
        with open(args.val_dataset_config) as f:
            val_dataset_config = json.load(f)
            print(val_dataset_config) 
