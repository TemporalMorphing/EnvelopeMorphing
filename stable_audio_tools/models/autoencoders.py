...
class AudioAutoencoder(nn.Module):
    ...
    def reconstruct_audio(
        ...
        **kwargs
        ...
        '''
        bs, n_ch, sample_length = audio.shape
        print("reconstruct_audio", bs, n_ch, sample_length)
    ...
    def morph_audio(
        ...
        **kwargs
        ...
        bs, n_ch, sample_length = audio_1.shape
        print("reconstruct_audio_1", bs, n_ch, sample_length)
        bs, n_ch, sample_length = audio_2.shape
        print("reconstruct_audio_2", bs, n_ch, sample_length)
        ...
        if not chunked:
            latent_1 = self.encode(audio_1, **kwargs)
            latent_2 = self.encode(audio_2, **kwargs)
            latent = weights_list[0] * latent_1 + weights_list[1] * latent_2
            return self.decode(latent, **kwargs)
        else:
            print("Please chunk")
            return audio_rec
